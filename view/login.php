...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo URL; ?>view/dist/img/favicon.png">
    <!-- Custom CSS -->
    <link href="<?php echo URL; ?>view/dist/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo URL; ?>view/dist/css/icheck-bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo URL; ?>view/dist/css/sweetalert2/sweetalert2.css" rel="stylesheet">
    <link href="<?php echo URL; ?>view/dist/css/style.min.css" rel="stylesheet">
        ...
        <div class="content-login">
            <div class="top-login">
                <div class="d-block mt-2">
                    <svg class="img-fluid" version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">

                        <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none" style="fill: aquamarine;">
            ...
            <div class="mid-login">
                <div class="text-center login-box-msg">
                    <span>Inicia Sesión para poder Ingresar al Administrador</span>
                </div>
                <form method="POST">
                    <div class="input-group">
                        <input class="form-control" type="text" name="user" placeholder="Ingrese su Usuario" value="<?php if (isset($_COOKIE["usu_r"]) && !empty($_COOKIE["pass_r"])) {
                                                                                                                        echo $_COOKIE["usu_r"];
                                                                                                                    } ?>">
                    ...
                    <br>
                    <div class="input-group">
                        <input class="form-control" type="password" name="passw" placeholder="Ingrese su Contraseña" value="<?php if (isset($_COOKIE["pass_r"]) && !empty($_COOKIE["pass_r"])) {
                                                                                                                                echo $_COOKIE["pass_r"];
                                                                                                                            } ?>">
                        <div class="input-group-append">
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="icheck-primary">
                                <input type="checkbox" id="remember" name="recordar" <?php if (isset($_COOKIE["usu_r"]) && !empty($_COOKIE["pass_r"])) { ?> checked <?php } ?>>
                                <label for="remember">
                                    Remember Me
                                </label>
                            </div>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $response = IngresoController::ctrLogin();

                        if ($response == "no-acceso") {
                            echo "<script>
